...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    category: "hoodies",
    sizes: TEE,
    swatches: ["#1f2937", "var(--primary)", "#8a8f98"],
  ...
  },
  {
    ...
    category: "printed",
    sizes: TEE,
    swatches: ["#eae5d7", "#1f2937", "var(--aqua)"],
  ...
  },
  {
    ...
    category: "printed",
    sizes: TEE,
    swatches: ["#1f2937", "var(--accent)", "#f4f0e6"],
  ...
  },
  {
    ...
    category: "plain",
    sizes: TEE,
    swatches: ["#f4f0e6", "#1f2937", "#8a8f98", "var(--aqua)"],
  ...
  },
  {
    ...
    category: "oversized",
    sizes: TEE,
    swatches: ["#f4f0e6", "var(--info)", "#1f2937"],
  ...
  },
  {
    ...
    category: "printed",
    sizes: TEE,
    swatches: ["#7a2f3a", "#1f2937", "var(--aqua)"],
  ...
  },
  {
    ...
    sizes: ONE,
    swatches: ["#1f2937", "#556b2f", "var(--primary)"],
  ...
  },
  {
    ...
    category: "printed",
    sizes: TEE,
    swatches: ["var(--accent)", "#f4f0e6", "var(--primary)"],
  ...
  },
  {
    ...
    category: "printed",
    sizes: TEE,
    swatches: ["#1f2937", "var(--aqua)", "var(--accent)"],
    image: img("p-street-combo"),
    tone: "linear-gradient(160deg,var(--primary),var(--aqua))",
    description:
